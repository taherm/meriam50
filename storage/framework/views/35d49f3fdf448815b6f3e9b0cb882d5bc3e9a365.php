...
<html>
<head>
    <title>Meriam Admin Panel</title>
...
<div id="wrapper">
    ...
    <div class="navbar-header">
        ...
        <h1> <a class="navbar-brand" href="/admin" target="_blank">Meriam</a></h1>
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="/admin/add-album" class=" hvr-bounce-to-right">
                            <i class="fa fa-snowflake-o nav_icon" ></i>
                            <span class="nav-label black">Add Album Image</span>
                        </a>
                    </li>
                    <li>
                        <a href="/admin/delete-album" class=" hvr-bounce-to-right">
                            <i class="fa fa-snowflake-o nav_icon" ></i>
                            <span class="nav-label black">Delete Album Image</span>
                        </a>
                    </li>
